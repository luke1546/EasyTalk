package com.ssafy.datamanager.config;
...
@MapperScan(basePackages = { "com.ssafy.datamanager.*.model.mapper" })
public class DataBaseConfiguration {
	...
	public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
		...
		session.setTypeAliasesPackage("com.ssafy.datamanager.*.model");
